              ...
              {chartData.map((item, index) => (
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    />
                    <span className="font-medium text-sm text-gray-900 dark:text-gray-100">{item.category}</span>
                  </div>
                  <div className="text-right">
                    <div className="font-semibold text-sm text-gray-900 dark:text-gray-100">₹{item.amount.toLocaleString()}</div>
                    <div className="text-xs text-gray-500 dark:text-gray-300">{item.percentage}%</div>
                  </div>
                </motion.div>
              ))}
            </div>
